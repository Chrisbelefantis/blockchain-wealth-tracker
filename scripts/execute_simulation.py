...
balances_start = np.array(accounts[1:])
print(balances_start)
    ...
    for row in reader:
        try:
            ...
            if accounts[from_user] >= amount:
                ...
                print("Transaction failed not enough tokens")
            if use_rewards:
                ...
                if(num_of_transactions[from_user]>=reward_interval):
                    ...
                    accounts[from_user] +=reward_amount
                ...
                if(num_of_transactions[to_user]>=reward_interval):
                    ...
                    accounts[to_user] +=reward_amount
                    num_of_rewards_given+=1
            
           
        except Exception as e:
            print(e.message," occured.")
    

#printAccounts(cityCoin)
balances_end = np.array(accounts[1:])
